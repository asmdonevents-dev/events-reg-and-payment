...
const badgeVariants = cva(
  'inline-flex items-center whitespace-nowrap justify-center border border-transparent focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline: 'bg-accent text-accent-foreground border border-asm-terracotta/20',
...
export { Badge, BadgeButton, BadgeDot, badgeVariants, badgeButtonVariants };
